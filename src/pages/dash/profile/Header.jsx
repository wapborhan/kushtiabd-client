...
const Header = () => {
  return (
    <>
      <div className="grid">
        <div className="rounded-lg border border-primary bg-white">
          <div className="flex flex-row  p-6">
            <div className="relative">
              <img
                className="w-40 h-40 rounded-md border border-dashed object-cover"
              ...
              <div
                className="absolute -right-3 bottom-5 h-5 w-5 sm:top-2 rounded-full border-4 border-white bg-green-500 sm:invisible md:visible animate-ping"
                title="User is online"
              >
              </div>
              <div
                className="absolute -right-3 bottom-5 h-5 w-5 sm:top-2 rounded-full border-4 bg-green-500 sm:invisible md:visible "
                title="User is online"
              >
              </div>
            </div>
            ...
            <div className="flex flex-col px-6">
              <div className="flex h-8 flex-row">
                ...
                <svg
                  className="my-auto ml-2 h-5 fill-blue-500"
              ...
              <div className="mt-2 flex flex-row items-center space-x-5">
                ...
                >
                  <div className="flex flex-row items-center justify-center">
                    ...
                    <span className="font-bold text-gray-600">10 Times</span>
                  </div>
                ...
                >
                  ...
                  <div className="mt-2 text-sm text-gray-400">Services</div>
                </Link>
      ...
      transition-all duration-150 ease-in-out hover:bg-gray-200">
          ...
          <div className="menu px-6 pt-5">
            <ul className="flex gap-5">
              <li className="pb-2 border-b-4 border-primary font-bold">
                Overview
              </li>
              <li className="">Services</li>
              <li className="">Blood Dnation</li>
